...
class Repository {
    ...
    fun getBooksList(bookType: BookType): List<Book> {
        ...
        val book5 = (Book("HarryPotter2", "J.K.Rowling", R.mipmap.book_cover, 3.3.toFloat(), true, "comment1"))
        val book6 = (Book("HarryPotter3", "J.K.Rowling", R.mipmap.book_cover, 4.2.toFloat(), true, "comment1"))
        val book7 = (Book("HarryPotter4", "J.K.Rowling", R.mipmap.book_cover, 2.1.toFloat(), true, "comment1"))
        val book8 = (Book("HarryPotter5", "J.K.Rowling", R.mipmap.book_cover, 5.0.toFloat(), true, "comment1"))
        val book9 = (Book("HarryPotter6", "J.K.Rowling", R.mipmap.book_cover, 4.9.toFloat(), true, "comment1"))
        val book10 = (Book("HarryPotter7", "J.K.Rowling", R.mipmap.book_cover, 5.0.toFloat(), true, "comment1"))


        val lended1 = LendedBook("lended_1", "author_1", R.mipmap.book_cover, 4.2.toFloat(), true, "interesting book",
        ...
        val lended5 = (LendedBook("HarryPotter2", "J.K.Rowling", R.mipmap.book_cover, 4.0.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25), LocalDate.of(2018, 6, 25)))
        ...
        val lended7 = (LendedBook("HarryPotter4", "J.K.Rowling", R.mipmap.book_cover, 3.5.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25), LocalDate.of(2018, 6, 25)))
        ...
        val lended9 = (LendedBook("HarryPotter6", "J.K.Rowling", R.mipmap.book_cover, 2.9.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25), LocalDate.of(2018, 6, 25)))
        val lended10 = (LendedBook("HarryPotter7", "J.K.Rowling", R.mipmap.book_cover, 4.8.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25), LocalDate.of(2018, 6, 25)))
        ...
        val borrowed3 = (BorrowedBook("HarryPotter1", "J.K.Rowling", R.mipmap.book_cover, 4.9.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25), LocalDate.of(2018, 6, 25)))
        ...
        val borrowed6 = (BorrowedBook("HarryPotter4", "J.K.Rowling", R.mipmap.book_cover, 2.7.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25), LocalDate.of(2018, 6, 25)))
        ...
        val borrowed8 = (BorrowedBook("HarryPotter6", "J.K.Rowling", R.mipmap.book_cover, 3.9.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25), LocalDate.of(2018, 6, 25)))

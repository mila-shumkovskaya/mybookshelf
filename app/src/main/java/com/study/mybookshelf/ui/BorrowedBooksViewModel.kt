...
class BorrowedBooksViewModel : ViewModel() {
    ...
    init {
        ...
        val borrowed6 = (BorrowedBook(5,"HarryPotter4", "J.K.Rowling", ByteArray(0), 5.0.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25).getString(), LocalDate.of(2018, 6, 25).getString()))
        val borrowed7 = (BorrowedBook(6,"HarryPotter5", "J.K.Rowling", ByteArray(0), 4.5.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25).getString(), LocalDate.of(2018, 6, 25).getString()))
        val borrowed8 = (BorrowedBook(7,"HarryPotter6", "J.K.Rowling", ByteArray(0), 5.0.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25).getString(), LocalDate.of(2018, 6, 25).getString()))
        val borrowed9 = (BorrowedBook(8,"HarryPotter2", "edited", ByteArray(0), 5.0.toFloat(), true, "comment1", "Dasha", LocalDate.of(2018, 6, 25).getString(), LocalDate.of(2018, 6, 25).getString()))

...
class LibraryViewModel : ViewModel() {
    ...
    init {
        ...
        val book4 = (LibraryBook(22,"HarryPotter1", "J.K.Rowling1", ByteArray(0), 5.0.toFloat(), true, "comment1"))
        val book5 = (LibraryBook(23,"HarryPotter2", "J.K.Rowling2", ByteArray(0), 3.9.toFloat(), true, "comment1"))
        val book6 = (LibraryBook(24,"HarryPotter3", "J.K.Rowling3", ByteArray(0), 5.0.toFloat(), true, "comment1"))
        val book7 = (LibraryBook(25,"HarryPotter4", "J.K.Rowling4", ByteArray(0), 4.7.toFloat(), true, "comment1"))
        val book8 = (LibraryBook(26,"HarryPotter5", "J.K.Rowling5", ByteArray(0), 5.0.toFloat(), true, "comment1"))
        val book9 = (LibraryBook(27,"HarryPotter6", "J.K.Rowling6", ByteArray(0), 2.6.toFloat(), true, "comment1"))
        val book10 = (LibraryBook(28,"HarryPotter7", "edited", ByteArray(0), 5.0.toFloat(), true, "comment1"))
